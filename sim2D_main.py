...
from scenarios.sim2D_VisualCoverage import FeedbackInformation, Controller, ControlOutput, SimSetup, SimulationCanvas
...
def main():
    ...
    ani = animation.FuncAnimation(sim.environment.fig, sim.loop_sequence, save_count=(SimSetup.tmax / SimSetup.Ts), interval = SimSetup.Ts*1000)
